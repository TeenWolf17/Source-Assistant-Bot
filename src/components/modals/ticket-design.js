...
module.exports = {
    ...
    async execute(interaction, client){
        ...
        const emb = new EmbedBuilder()
            .setTitle(`Ticket`)
            .setDescription(`${interaction.user} DESIGN Ticket created
        ...
        await client.channels.fetch(client.channelsLists.ticketDesign)
            .then( channel => {
                channel.guild.channels.create({
                    name: `design-${interaction.user.username}`,
                    type: ChannelType.GuildText,
                    parent: client.channelsLists.ticketDesign,
